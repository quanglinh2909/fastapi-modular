...
from pymodular.infrastructure.mqtt.metrics import mqtt_publish_failed, mqtt_published
from pymodular.infrastructure.mqtt.patterns import narrow_filters, validate_topic
...
def _require_aiomqtt() -> Any:
    try:
        ...
        raise ComponentNotEnabledError(
            ...
            "Chạy `pip install 'pymodular[mqtt]'`, hoặc đặt APP_MQTT__ENABLED=false nếu "
...
class MqttClient:
    ...
    def client_id(self) -> str:
        return self._config.client_id or f"pymodular-{uuid.uuid4().hex[:8]}"
